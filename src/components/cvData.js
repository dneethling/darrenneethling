const CVData = {
  ...
  profile: {
    icon: "user", // This assumes you're using an icon library like Font Awesome or Lucide where "user" represents a profile icon
  ...
  experience: [
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Implemented and managed various enterprise systems, including Learning Management Systems, Mobile Device Management, and VoIP, streamlining operations and enhancing communication.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Led Graphics Design curriculum using Adobe Creative Cloud, and taught advanced Computer Science concepts including JAVA programming for grades 10-12.",
