const CVData = {
  ...
  experience: [
    {
      ...
      responsibilities: [
        ...
        "Develop and deliver services in automation, system integration, AI literacy, applied AI solutions, IT infrastructure, and fractional technology leadership, turning AI hype into measurable, real-world impact for global brands including L'Oréal, Seraphine, Vagabond, and Food for Tails.",
        "Lead specialist practices spanning AI consulting (DCAI), compliance advisory (dc-comply), and CMMC / U.S. Department of Defense cybersecurity certification (cmmcDirected), serving clients such as TechDIRECTED and St Stephen's.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Implement robust cybersecurity measures and data protection protocols, ensuring compliance with GDPR and other relevant regulations.",
        "Spearhead the deployment of single sign-on solutions (ClassLink) and modernize IT infrastructure, enhancing user experience and system security.",
        "Develop and execute disaster recovery and business continuity plans, minimizing potential downtime and data loss risks.",
        "Lead a cross-functional IT team, fostering innovation and driving continuous improvement in service delivery.",
        "Implement data analytics solutions, creating dashboards for various departments to enable data-driven decision making.",
        "Serve as Data Protection Officer, managing the organization's compliance with data protection regulations.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Implemented and managed various enterprise systems, including Learning Management Systems (Managebac, Google Classroom, Toddle, SeeSaw), Child Protection Services (CPOMS, Tootoot), Library Information System (Follett), Helpdesk (FreshDesk), Mobile Device Management (Jamf, Apple School Manager), Microsoft (Active Directory, Azure services, Office365, VMware), Adobe, PaperCut, 3CX VoIP telephone systems, and NWEA Student mapping.",
        "Established IT policies and procedures, ensuring alignment with industry best practices and regulatory requirements.",
        "Managed vendor relationships and led complex IT projects, consistently delivering on time and within budget.",
        "Implemented a comprehensive Mobile Device Management solution, securing and managing 500+ devices across the organization.",
        "Conducted regular security audits and implemented measures to enhance the organization's cybersecurity posture.",
        "Managed local and cloud servers, overseeing tech assets from procurement to disposal.",
        "Responsible for videography for school events, including graduation and live streaming.",
        "Led robotics and media team extracurricular activities.",
        "Served as ICT/Computer Science Educator for grades 8 and 9."
      ]
    },
    {
      ...
      responsibilities: [
        ...
        "Developed and delivered technical training programs, improving digital literacy and reducing IT support tickets.",
        "Led the transition to Google Workspace, improving collaboration and productivity across the organization.",
        "Managed the implementation of 'Flipped Classroom' technology, showcasing ability to integrate innovative tech solutions.",
        "Served as Microsoft Office Specialist (MOS) Trainer, training approximately 180 learners."
      ]
    },
    {
      ...
      responsibilities: [
        ...
        "Pioneered the implementation of 'Flipped Classroom' technology, showcasing ability to integrate innovative tech solutions in educational settings.",
        "Conducted ongoing research on emerging educational technologies and applications, driving continuous improvement in classroom tech integration.",
        "Led Graphics Design curriculum using Adobe Creative Cloud for grades 8-9, and taught advanced Computer Science concepts including JAVA programming for grades 10-12.",
        "Managed and optimized the school's educational technology ecosystem, ensuring seamless integration of IT resources with curriculum delivery."
      ]
    },
    {
      ...
      responsibilities: [
        ...
        "Coordinated complex logistics for student teaching practices, utilizing project management software and digital collaboration tools.",
        "Conducted digital assessments of final year students, leveraging online platforms and analytics tools to provide comprehensive feedback.",
        "Served as PGCE (Post Graduate Certificate in Education) Administrator & Teaching Practice Assistant."
      ]
    }
  ],
  skills: [
  ...
  affiliations: [
    { role: "EDEH Squad Member", organization: "European Digital Education Hub", period: "August 2024 - Present", url: "https://education.ec.europa.eu/focus-topics/digital-education/action-plan/european-digital-education-hub", icon: "/edeh.png" },
    { role: "Founding Member", organization: "Human Intelligence Movement", period: "July 2024 - Present", url: "https://www.humanintelligencemovement.org/", icon: "/human.png" },
    { role: "Leadership Team Member", organization: "Technology Readiness Council", period: "November 2023 - Present", url: "https://technologyreadiness.org/", icon: "/trc.png" },
    { role: "Advisory Board Member", organization: "EDUtech Europe", period: "December 2023 - Present", url: "https://edutechtalks.com/innovation-amplified-meet-the-minds-steering-edutech-europe-2024/", icon: "/edutech.png" }
  ],
  additionalExperiences: [
    "Participated as a driver for Maragon Solar Eagles in the Sasol Solar Challenge 2014, securing 6th place out of 10 overall and contributing to the achievement of 5 awards.",
    "Holds valid Motor Vehicle and Motorcycle driver's licenses (Code EB & A) obtained in 2008, along with a Professional Driver's Permit (PDP)."
  ]
};
